  ...
  return (
    <div className="relative" ref={menuRef}>
      <button
        ...
        className="flex items-center gap-2 px-3 py-2 text-gray-700 bg-white border border-gray-200 rounded-lg hover:bg-gray-50 transition-colors text-sm relative whitespace-nowrap"
      >
                ...
                {sortOptions.slice(0, 4).map((option) => (
                  <div key={option.key} className="flex gap-1">
                    <button
                      ...
                      className={`flex-1 text-xs px-2 py-1 rounded transition-colors border border-gray-100 ${
