...
export const FilterBar: React.FC<FilterBarProps> = ({
  ...
  return (
    <div className="bg-gradient-to-r from-gray-50 to-gray-50/50 border-b border-gray-200/60 sticky top-20 z-30 overflow-x-hidden">
      <div className="px-4 py-3 sm:px-6 sm:py-4">
        ...
        <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3 sm:gap-0 mb-3">
          ...
          <div className="flex flex-wrap justify-end gap-2 sm:gap-3 w-full sm:w-auto">
            ...
            <button className="flex items-center gap-2 px-3 py-1.5 text-xs text-indigo-600 bg-indigo-50 rounded-full hover:bg-indigo-100 transition-colors whitespace-nowrap">
          ...
          <div className="flex flex-wrap items-center gap-x-3 gap-y-2 pt-3 border-t border-gray-200">
            ...
            <div className="flex flex-wrap gap-x-2 gap-y-1">
              {filters.map((filter) => (
                <div
                  key={filter.id}
                  className="group flex items-center gap-2 px-3 py-1.5 bg-white/80 backdrop-blur-sm border border-indigo-200/60 rounded-full text-xs sm:text-sm font-medium text-gray-700 hover:bg-white hover:border-indigo-300 transition-all duration-200 shadow-sm"
                >
            ...
            <div className="flex items-center gap-3 ml-auto mt-2 sm:mt-0">
              <button
                onClick={onClearAll}
                className="text-xs sm:text-sm text-gray-600 hover:text-gray-900 transition-colors duration-200 font-medium whitespace-nowrap"
              >
                Clear All
              </button>
              ...
              <button
                ...
                className="flex items-center gap-2 px-3 py-1.5 text-xs sm:text-sm text-gray-700 bg-white/80 backdrop-blur-sm border border-gray-200 rounded-lg hover:bg-white hover:border-gray-300 transition-all duration-200 shadow-sm whitespace-nowrap"
              >
